...
public class StandardFactory {
    ...
    private final String ROMS_DIR = System.getProperty("user.dir") + "\\src\\main\\resources\\roms\\";
    ...
    private ROM createCharRom() throws IOException {
        return new ROM("char", new File(ROMS_DIR + "characters.901225-01.bin"));
    }

    private ROM createBasicRom() throws IOException {
        return new ROM("basic", new File(ROMS_DIR + "basic.901226-01.bin"));
    }

    private ROM createKernalRom() throws IOException {
        return new ROM("kernal",new File(ROMS_DIR + "kernal.901227-03.bin"));
    }
}
