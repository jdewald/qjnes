...
public class Keyboard implements IODevice, KeyListener {
    ...
    */
    ...
    final int keyColumn[] = new int[]{VK_INSERT, VK_ENTER, VK_RIGHT, VK_F7, VK_F1, VK_F3, VK_F5, VK_DOWN,
    ...
    final int shiftedKeyColumn[] = new int[]{VK_INSERT, VK_ENTER, VK_LEFT, VK_F7, VK_F1, VK_F3, VK_F5, VK_UP,
