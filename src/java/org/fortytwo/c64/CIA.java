...
import org.fortytwo.c64.io.IODevice;
        ...
        case TIMER_A_CONTROL: // 0E
            {
                ...
                if ((value & TIMER_A_UNDERFLOW_STARTSTOP) != 0){
                    timerARestart = false;
                }
                else {
                    timerARestart = true;
        ...
        case TIMER_B_CONTROL: // 0F
            {
                ...
                if ((value & TIMER_B_UNDERFLOW_STARTSTOP) != 0){
                    timerBRestart = false;
                }
                else {
                    timerBRestart = true;
            ...
            break;
        default: throw new RuntimeException(name + ":Don't know how to handle write to: " + address);
        }
