 ...
 */
public class MOS6502InstructionSet implements InstructionSet
{
	...
	new ADC_Instruction(Instruction.AddressingMode.PreIndexedIndirect), // 61
	null, // 62 - HLT
	...
	new ADC_Instruction(Instruction.AddressingMode.ZeroPageAbsolute), // 65
	...
	new ADC_Instruction(Instruction.AddressingMode.Immediate), // 69
	...
	new ADC_Instruction(Instruction.AddressingMode.Absolute), // 6D
	...
	new ADC_Instruction(Instruction.AddressingMode.PostIndexedIndirect), // 71
	null, // 72 - HLT
	...
	new ADC_Instruction(Instruction.AddressingMode.ZeroPageIndexedX), // 75
	...
	new ADC_Instruction(Instruction.AddressingMode.IndexedY), // 79
	...
	new ADC_Instruction(Instruction.AddressingMode.IndexedX), // 7D
	...
	new SBC_Instruction(Instruction.AddressingMode.PreIndexedIndirect),
	...
	new SBC_Instruction(Instruction.AddressingMode.ZeroPageAbsolute),
	...
	new SBC_Instruction(Instruction.AddressingMode.Immediate), // E9
	new NOP_Instruction(Instruction.AddressingMode.Implied), // EA
	new SBC_Instruction(Instruction.AddressingMode.Immediate), // EB
	new CPX_Instruction(Instruction.AddressingMode.Absolute), // EC
	new SBC_Instruction(Instruction.AddressingMode.Absolute), // ED
	...
	new SBC_Instruction(Instruction.AddressingMode.PostIndexedIndirect), //F1
	null, // F2 - HLT
	...
	new SBC_Instruction(Instruction.AddressingMode.ZeroPageIndexedX),
	...
	new SBC_Instruction(Instruction.AddressingMode.IndexedY), // f9
	null,
	...
	new SBC_Instruction(Instruction.AddressingMode.IndexedX),
